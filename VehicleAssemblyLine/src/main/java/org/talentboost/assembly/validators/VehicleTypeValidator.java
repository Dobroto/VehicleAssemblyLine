 ...
 * In the constructor a map is created which contains as key for example "car"
...
public class VehicleTypeValidator implements IValidator {
	...
	/**
	 * The method parseVehicleType accepts vehicle type(for example "car")
	 * and using parsers finds the correct vehicle type object (for example car object).
